  ...
  return (
    <aside className="fixed h-screen w-screen sm:w-[17vw] bg-card-color z-10">
      <Image
        ...
        height={30}
        width={35}
        className="ml-[15vw] sm:mx-auto pt-16 pb-10"
        alt={"logo"}
      />

      <div className="flex-col">
        <div className="flex items-center pl-[15vw] sm:pl-[3.75vw] pt-6">
          <FontAwesomeIconWrapper icon={faHouse} />
          <p className="ml-4">Overview</p>
        </div>

        <div className="flex items-center pl-[15vw] sm:pl-[3.75vw] pt-6 text-txt-color-secondary hover:text-white cursor-pointer">
      ...
      <div className="flex items-center pl-[15vw] sm:pl-[3.75vw] absolute bottom-0 pb-10  text-txt-color-secondary hover:text-white cursor-pointer">
